import{l as s,o as c,g as n,d as e}from"./orders-CBA0M2t7.js";/* empty css                      */import{c as i}from"./checkoutHeader-HEDuh_7p.js";import{u as o}from"./amazon-CA2kPw1k.js";new Promise(async()=>{try{await s()}catch{console.log("unexpected error. please try again later.")}l()});function l(){let t="";c.forEach(a=>{a.products.forEach(d=>{let r=n(d.productId);t+=`
